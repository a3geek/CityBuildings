...
namespace LineStructures.Examples.Components
{
    ...
    [AddComponentMenu("")]
    public class StraightLineChecker : AbstractLineChecker
    {
        ...
        [Header("Straight Line Params")]
        public float Magnitude = 1000f;

        [SerializeField]
        protected bool centeringGizmos = true;
        ...
        {
            this.line.DrawGizmos(0f, this.centeringGizmos);
        }
    }
}
